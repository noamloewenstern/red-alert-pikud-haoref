...
export type Options<FunctionToMemoize extends AnyAsyncFunction, CacheKeyType> = {
  ...
  /**
	Only cache if value returned is equal to value passed to cacheValue.

	@default undefined
	@example true
	*/
  readonly cacheOnResult?: (val: AsyncReturnType<FunctionToMemoize>) => boolean;
};
